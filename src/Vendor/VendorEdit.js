        ...
        <div className="vendors table-responsive-sm">
          ...
          { vendorData ? (
              ...
              <div className="modify-973E-form">
                  ...
                  <div className="form-group">
                      <div className="col-sm-3">
                      <input type="checkbox" id="webcheck" name="webcheck" className="form-check-input" onChange={handleCheckboxChange}/>
                  ...
                  <div className="form-group">
                      <div className="col-sm-3">
                      <input type="checkbox" id="usernamecheck" name="usernamecheck" className="form-check-input" onChange={handleCheckboxChange}/>
                  ...
                  <div className="form-group">
                      <div className="col-sm-3">
                      <input type="checkbox" id="pwdcheck" name="pwdcheck" className="form-check-input" onChange={handleCheckboxChange} />
